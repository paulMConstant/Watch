...
class Client : public QObject
{
  ...
  public:
    ...
    [[nodiscard]] bool isConnectingToServer() const noexcept;
  ...
  public slots:
    ...
    void cancelConnecting() noexcept;
  ...
  private slots:
    ...
    void sslErrors(QList<QSslError> errors) noexcept;
  ...
  private:
    ...
    quint16 msgSize = 0;
    QString name;
    enum class State {Unconnected, TryingToConnect, WaitingForPasswordACK, Connected};
